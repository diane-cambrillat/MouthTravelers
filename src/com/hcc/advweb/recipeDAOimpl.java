...
public class recipeDAOimpl implements recipeDAO {
	...
	public ArrayList<recipe> getRecipeList() {
		ArrayList<recipe> recipeList = 
				...
				getCurrentSession().createQuery("FROM recipe").
				list();
		return recipeList;
	}
	...
	public ArrayList<recipe> getRecipeListUSA() {
		ArrayList<recipe> recipeListUSA = 
				(ArrayList<recipe>)sessionFactory.
				getCurrentSession().createQuery("FROM recipe WHERE country='USA'").
				list();
	...
	public ArrayList<recipe>  getRecipeListFR(){
		ArrayList<recipe> recipeListFr = 
				(ArrayList<recipe>)sessionFactory.
				getCurrentSession().createQuery("FROM recipe WHERE country='France'").
				list();
		return recipeListFr;
	}
